...
#include "poScene/TextView.h"
            ...
            class TouchButton;
            typedef std::shared_ptr<TouchButton> TouchButtonRef;


            typedef ci::signals::Signal<void( TouchButtonRef )> TouchButtonSignal;

            class TouchButton : public po::scene::View
            {
            public:
                enum class Type {
                    NORMAL = 0,
                ...
                TouchButtonSignal& getSignalPressed() { return mSignalPressed; }
                TouchButtonSignal& getSignalToggled() { return mSignalToggled; }
                TouchButtonSignal& getSignalStateSet() { return mSignalStateSet; }
         ...
         //   protected:
                ...
                int originX;
                int originY;
                ci::Color originColor;
                ci::vec2  mInflate;

                void setInflate(ci::vec2);
                ...
                void setTintOffsetAndAlphaForState( po::scene::ViewRef view, std::map<State, ci::Color> tints, std::map<State, ci::vec2> offsets, std::map<State, float> alphas, State state );
                void setScaleForState( po::scene::ViewRef view, std::map<State, ci::vec2> scales, State state );

                // Background Images
                po::scene::ImageViewRef mBackgroundImageView = nullptr;
                ...
                TouchButtonSignal mSignalPressed, mSignalToggled, mSignalStateSet;
